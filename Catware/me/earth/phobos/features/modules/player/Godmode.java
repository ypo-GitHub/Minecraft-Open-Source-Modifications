...
public class Godmode extends Module {
  private final Setting<Boolean> remount = register(new Setting("Remount", Boolean.valueOf(false)));
  ...
  public void onPlayerWalkingUpdate(UpdateWalkingPlayerEvent event) {
    if (this.entity == null)
      return; 
    if (event.getStage() == 0) {
      if (((Boolean)this.remount.getValue()).booleanValue() && ((Godmode)Objects.<Module>requireNonNull(Phobos.moduleManager.getModuleByClass(Godmode.class))).isEnabled())
