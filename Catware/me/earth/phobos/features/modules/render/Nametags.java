...
public class Nametags extends Module {
  ...
  private final Setting<Boolean> colorSync = register(new Setting("Sync", Boolean.valueOf(false), v -> ((Boolean)this.outline.getValue()).booleanValue()));
  ...
  private void renderNameTag(EntityPlayer player, double x, double y, double z, float delta) {
    ...
    if (((Boolean)this.rect.getValue()).booleanValue()) {
      drawRect((-width - 2), -(this.renderer.getFontHeight() + 1), width + 2.0F, 1.5F, 1426063360);
      if (((Boolean)this.outline.getValue()).booleanValue()) {
        int color = ((Boolean)this.colorSync.getValue()).booleanValue() ? Colors.INSTANCE.getCurrentColorHex() : (new Color(((Integer)this.redSetting.getValue()).intValue(), ((Integer)this.greenSetting.getValue()).intValue(), ((Integer)this.blueSetting.getValue()).intValue(), ((Integer)this.alphaSetting.getValue()).intValue())).getRGB();
