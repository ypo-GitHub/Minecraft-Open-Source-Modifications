...
public class TPSpeed extends Module {
  ...
  private final Setting<Double> speed = register(new Setting("Speed", Double.valueOf(0.25D), Double.valueOf(0.1D), Double.valueOf(10.0D)));
  
  private final Setting<Double> fallSpeed = register(new Setting("FallSpeed", Double.valueOf(0.25D), Double.valueOf(0.1D), Double.valueOf(10.0D), v -> (this.mode.getValue() == Mode.STEP)));
  
  private final Setting<Boolean> turnOff = register(new Setting("Off", Boolean.valueOf(false)));
  
  private final Setting<Integer> tpLimit = register(new Setting("Limit", Integer.valueOf(2), Integer.valueOf(1), Integer.valueOf(10), v -> ((Boolean)this.turnOff.getValue()).booleanValue(), "Turn it off."));
  
  private int tps = 0;
  
  private final double[] selectedPositions = new double[] { 0.42D, 0.75D, 1.0D };
  ...
  public void onUpdatePlayerWalking(UpdateWalkingPlayerEvent event) {
    ...
    //   65: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   68: getfield moveForward : F
    //   71: fconst_0
    //   72: fcmpl
    //   73: ifne -> 102
    //   76: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   79: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   82: getfield moveStrafing : F
    //   85: fconst_0
    //   86: fcmpl
    //   87: ifeq -> 818
    //   90: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   93: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   96: getfield onGround : Z
    //   99: ifeq -> 818
    //   102: ldc2_w 0.0625
    //   105: dstore_2
    //   106: dload_2
    ...
    //   133: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   136: getfield connection : Lnet/minecraft/client/network/NetHandlerPlayClient;
    ...
    //   146: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   149: getfield posX : D
    //   152: aload #4
    //   154: iconst_0
    //   155: daload
    ...
    //   160: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   163: getfield posY : D
    //   166: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   169: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   172: getfield posZ : D
    //   175: aload #4
    //   177: iconst_1
    //   178: daload
    ...
    //   183: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   186: getfield onGround : Z
    //   189: invokespecial <init> : (DDDZ)V
    //   192: invokevirtual sendPacket : (Lnet/minecraft/network/Packet;)V
    //   195: dload_2
    //   196: ldc2_w 0.262
    //   199: dadd
    //   200: dstore_2
    ...
    //   207: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   210: getfield connection : Lnet/minecraft/client/network/NetHandlerPlayClient;
    ...
    //   220: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   223: getfield posX : D
    //   226: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   229: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   232: getfield motionX : D
    //   235: dadd
    //   236: dconst_0
    //   237: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   240: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   243: getfield posZ : D
    //   246: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   249: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   252: getfield motionZ : D
    //   255: dadd
    //   256: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   259: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   262: getfield onGround : Z
    //   265: invokespecial <init> : (DDDZ)V
    //   268: invokevirtual sendPacket : (Lnet/minecraft/network/Packet;)V
    //   271: aload_0
    //   272: dup
    //   273: getfield tps : I
    //   276: iconst_1
    ...
    //   287: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   290: getfield moveForward : F
    //   293: fconst_0
    //   294: fcmpl
    //   295: ifne -> 312
    //   298: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   301: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   304: getfield moveStrafing : F
    //   307: fconst_0
    //   308: fcmpl
    //   309: ifeq -> 818
    //   312: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   315: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   318: getfield onGround : Z
    //   321: ifeq -> 818
    //   324: dconst_0
    //   325: dstore_2
    //   326: ldc2_w 0.262
    ...
    //   368: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   371: invokevirtual getEntityBoundingBox : ()Lnet/minecraft/util/math/AxisAlignedBB;
    ...
    //   387: iconst_1
    //   388: daload
    //   389: invokevirtual offset : (DDD)Lnet/minecraft/util/math/AxisAlignedBB;
    //   392: astore #8
    //   394: aload #8
    ...
    //   433: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   436: getfield connection : Lnet/minecraft/client/network/NetHandlerPlayClient;
    ...
    //   446: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   449: getfield posX : D
    //   452: aload #7
    //   454: iconst_0
    //   455: daload
    ...
    //   465: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   468: getfield posY : D
    //   471: dload_2
    //   472: dadd
    //   473: dload #12
    ...
    //   479: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   482: getfield posZ : D
    //   485: aload #7
    //   487: iconst_1
    //   488: daload
    ...
    //   499: invokevirtual sendPacket : (Lnet/minecraft/network/Packet;)V
    //   502: iinc #11, 1
    //   505: goto -> 416
    //   508: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   511: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   514: invokevirtual getEntityBoundingBox : ()Lnet/minecraft/util/math/AxisAlignedBB;
    ...
    //   534: iconst_1
    //   535: daload
    //   536: invokevirtual offset : (DDD)Lnet/minecraft/util/math/AxisAlignedBB;
    //   539: astore #8
    //   541: goto -> 394
    ...
    //   555: dconst_0
    //   556: ldc2_w 0.0125
    //   559: invokevirtual grow : (DDD)Lnet/minecraft/util/math/AxisAlignedBB;
    //   562: dconst_0
    //   563: ldc2_w -1.0
    //   566: dconst_0
    //   567: invokevirtual offset : (DDD)Lnet/minecraft/util/math/AxisAlignedBB;
    //   570: invokevirtual checkBlockCollision : (Lnet/minecraft/util/math/AxisAlignedBB;)Z
    //   573: ifne -> 673
    //   576: dconst_0
    //   577: dstore #9
    //   579: dload #9
    ...
    //   589: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   592: getfield connection : Lnet/minecraft/client/network/NetHandlerPlayClient;
    ...
    //   602: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   605: getfield posX : D
    //   608: aload #7
    //   610: iconst_0
    //   611: daload
    ...
    //   616: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   619: getfield posY : D
    //   622: dload_2
    //   623: dadd
    //   624: dload #9
    ...
    //   630: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   633: getfield posZ : D
    //   636: aload #7
    //   638: iconst_1
    //   639: daload
    ...
    //   645: invokevirtual sendPacket : (Lnet/minecraft/network/Packet;)V
    //   648: dload #9
    //   650: aload_0
    ...
    //   676: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   679: getfield connection : Lnet/minecraft/client/network/NetHandlerPlayClient;
    ...
    //   689: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   692: getfield posX : D
    //   695: aload #7
    //   697: iconst_0
    //   698: daload
    ...
    //   703: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   706: getfield posY : D
    //   709: dload_2
    //   710: dadd
    //   711: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   714: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   717: getfield posZ : D
    //   720: aload #7
    //   722: iconst_1
    //   723: daload
    ...
    //   728: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   731: getfield onGround : Z
    //   734: invokespecial <init> : (DDDZ)V
    //   737: invokevirtual sendPacket : (Lnet/minecraft/network/Packet;)V
    //   740: dload #5
    //   742: ldc2_w 0.262
    //   745: dadd
    //   746: dstore #5
    ...
    //   754: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   757: getfield connection : Lnet/minecraft/client/network/NetHandlerPlayClient;
    ...
    //   776: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   779: getfield motionX : D
    //   782: dadd
    //   783: dconst_0
    //   784: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   787: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   790: getfield posZ : D
    //   793: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   796: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   799: getfield motionZ : D
    //   802: dadd
    //   803: getstatic me/earth/phobos/features/modules/movement/TPSpeed.mc : Lnet/minecraft/client/Minecraft;
    //   806: getfield player : Lnet/minecraft/client/entity/EntityPlayerSP;
    //   809: getfield onGround : Z
    //   812: invokespecial <init> : (DDDZ)V
    //   815: invokevirtual sendPacket : (Lnet/minecraft/network/Packet;)V
    //   818: return
    // Line number table:
