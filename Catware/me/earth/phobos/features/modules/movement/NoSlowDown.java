...
public class NoSlowDown extends Module {
  ...
  public void onUpdate() {
    ...
    if (((Boolean)this.webs.getValue()).booleanValue() && ((Flight)Phobos.moduleManager.getModuleByClass(Flight.class)).isDisabled() && ((Phase)Phobos.moduleManager.getModuleByClass(Phase.class)).isDisabled() && mc.player.isInWeb) {
