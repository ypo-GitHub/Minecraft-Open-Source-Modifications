...
public class CustomFont extends CFont {
  ...
  public float drawString(String textIn, double xI, double yI, int color, boolean shadow) {
    String text = (Media.getInstance().isOn() && ((Boolean)(Media.getInstance()).changeOwn.getValue()).booleanValue()) ? textIn.replace(Media.getPlayerName(), (CharSequence)(Media.getInstance()).ownName.getValue()) : textIn;
    double x = xI;
    double y = yI;
