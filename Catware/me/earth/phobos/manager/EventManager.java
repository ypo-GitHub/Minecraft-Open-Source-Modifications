...
public class EventManager extends Feature {
  ...
  public void onSettingChange(ClientEvent event) {
    if (event.getStage() == 2 && mc.getConnection() != null && ServerModule.getInstance().isConnected() && mc.world != null) {
  ...
  public void onPacketSend(PacketEvent.Send event) {
    if (event.getPacket() instanceof net.minecraft.network.play.client.CPacketHeldItemChange)
