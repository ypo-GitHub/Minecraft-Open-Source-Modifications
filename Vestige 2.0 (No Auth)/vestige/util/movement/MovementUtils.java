...
public class MovementUtils implements BaseUtil {
	...
	public static void speedBoost(float speed) {
        ...
        if(Vestige.getModuleManager().getModuleByName("Killaura").isEnabled() && ((Killaura) (Vestige.getModuleManager().getModuleByName("Killaura"))).target != null && ((Killaura) (Vestige.getModuleManager().getModuleByName("Killaura"))).moveFix.isEnabled()) {
            f = ((Killaura) (Vestige.getModuleManager().getModuleByName("Killaura"))).yaw * 0.017453292F;
        }
