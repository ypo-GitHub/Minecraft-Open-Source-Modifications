...
public class Killaura extends Module {
	...
	public void onEvent(Event event) {
		...
		if(Vestige.getModuleManager().getModuleByName("Scaffold").isEnabled()) {
			if(target != null) {
				releaseBlocking();
				target = null;
			}
