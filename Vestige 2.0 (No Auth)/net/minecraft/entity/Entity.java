...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            boolean shouldSafeWalk = Vestige.getModuleManager().getModuleByName("Scaffold").isEnabled() || Vestige.getModuleManager().getModuleByName("AutoBridge").isEnabled();
            boolean onlyOnGround = Vestige.getModuleManager().getModuleByName("Scaffold").isEnabled() ? true : false;
