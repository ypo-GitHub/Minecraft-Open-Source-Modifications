...
public class ColorPicker extends Component {
  ...
  public void renderComponent() {
    GL11.glEnable(3042);
    Gui.drawRect(this.parent.parent.getX() + 2, this.parent.parent.getY() + this.offset, this.parent.parent.getX() + this.parent.parent.getWidth(), this.parent.parent.getY() + this.offset + 12, -1507712478);
    Gui.drawRect(this.parent.parent.getX() + 2, this.parent.parent.getY() + this.offset, this.parent.parent.getX() + this.parent.parent.getWidth(), this.parent.parent.getY() + this.offset + 12, this.set.getcolor());
    Gui.drawRect((int)(this.parent.parent.getX() + this.renderWidth), this.parent.parent.getY() + this.offset, this.parent.parent.getX() + (int)this.renderWidth + 6, this.parent.parent.getY() + this.offset + 12, -1086045116);
