...
public final class Time extends Module {
  ...
  public void setup() {
    ...
    Main.setmgr.add(ypos = new Setting("ypos", this, 190.0D, -20.0D, (mc.displayHeight / 2 + 40), true));
  }
  ...
  public static class TimeRUN extends PinableFrame {
    ...
    public void setup() {
      GetSetup(this, Time.xpos, Time.ypos, Time.Frame, Time.FontSize);
    }
    
    public void Ongui() {
      GetInit(this, Time.xpos, Time.ypos, Time.Frame, Time.FontSize);
    }
    ...
    public void onRenderGameOverlay(RenderGameOverlayEvent.Text event) {
      ...
      if (Time.GameTime.getValBoolean())
        time = time + this.mc.world.getWorldTime(); 
      fontSelect(Time.Frame, time, getX(), (getY() + 10), Time.TextColor.getcolor(), Time.Shadow.getValBoolean());
      if (Time.background.getValBoolean())
        Gui.drawRect(this.x, this.y + 10, this.x + widthcal(Time.Frame, time), this.y + 20, Time.BgColor.getcolor()); 
