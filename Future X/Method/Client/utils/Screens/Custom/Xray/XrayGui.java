...
public final class XrayGui extends GuiScreen {
  ...
  public void initGui() {
    this.listGui = new ListGui(this.mc, this, XrayGuiSettings.getBlockNames(), 500, 0);
    this.Allblocks = new ListGui(this.mc, this, XrayGuiSettings.getAllBlockNames(XrayGuiSettings.getBlockNames()), 0, 0);
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    ...
    switch (button.id) {
      ...
      case 3:
        ...
        xray = ModuleManager.getModuleByName("Xray");
        if (xray.isToggled()) {
  ...
  protected void keyTyped(char typedChar, int keyCode) throws IOException {
    ...
    if (!this.blockNameField.getText().isEmpty()) {
      this.Allblocks.list = XrayGuiSettings.SearchBlocksAll(XrayGuiSettings.getBlockNames(), this.blockNameField.getText());
    } else {
      this.Allblocks.list = XrayGuiSettings.getAllBlockNames(XrayGuiSettings.getBlockNames());
    } 
  }
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks) {
    ...
    drawCenteredString(this.mc.fontRenderer, "XRAY (" + this.listGui.getSize() + ")", this.width / 2, 12, 16777215);
