...
public final class ClassTransformer implements IClassTransformer {
  ...
  public byte[] transform(String name, String transformedName, byte[] basicClass) {
    ...
    try {
      ...
      reader.accept(((Class<ClassVisitor>)this.visitors.get(transformedName)).getConstructor(new Class[] { ClassVisitor.class, boolean.class }, ).newInstance(new Object[] { writer, Boolean.valueOf(obfuscated) }, ), 0);
