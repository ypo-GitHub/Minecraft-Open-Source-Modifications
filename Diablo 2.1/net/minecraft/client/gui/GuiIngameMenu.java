...
public class GuiIngameMenu extends GuiScreen
{
    ...
    private final IntentAccount accountinfo = Diablo.getIntentAccount();
    private final String intentuser = accountinfo.username;
    private final String intentuid = String.valueOf(accountinfo.client_uid);
    private final String intentdiscordid = accountinfo.discord_id;
    private String intentdiscordtag = accountinfo.discord_tag;
