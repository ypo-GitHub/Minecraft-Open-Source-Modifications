...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String loggedInStr = ChatColor.WHITE + "Logged in as: " + ChatColor.GREEN + Diablo.getIntentAccount().username + ChatColor.GRAY + " (" + ChatColor.AQUA +Diablo.getIntentAccount().client_uid + ChatColor.GRAY +")";
