...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
    ...
    public void func_152930_t()
    {
        ...
        LOGGER.info(STREAM_MARKER, "Streaming at {}/{} at {} kbps to {}", Integer.valueOf(videoparams.outputWidth), Integer.valueOf(videoparams.outputHeight), Integer.valueOf(videoparams.maxKbps), this.broadcastController.func_152833_s().serverUrl);
