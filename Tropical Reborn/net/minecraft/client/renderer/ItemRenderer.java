...
import swapper.intentions.tropical.module.render.Animations;
...
public class ItemRenderer
{
    ...
    {
        Animations anims = (Animations) Tropical.instance.moduleManager.getModuleByName("Animations");
        GlStateManager.translate(-0.5F, 0.2F + anims.extraY.getValue(), 0.0F);
        GlStateManager.scale(anims.itemScale.getValue(), anims.itemScale.getValue(), anims.itemScale.getValue());
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        {
        	KillAura aura = (KillAura) Tropical.instance.moduleManager.getModuleByName("KillAura");
        	Animations anims = (Animations) Tropical.instance.moduleManager.getModuleByName("Animations");
            if (this.itemToRender.getItem() instanceof ItemMap)
            {
                this.renderItemMap(entityplayersp, f2, f, f1);
            }
            else if (entityplayersp.getItemInUseCount() > 0 || aura != null && aura.target != null && aura.autoBlock.getValue() && (aura.autoBlockMode.getCurrentValue() == "Fake" || anims != null && anims.fullBlock.getValue()) && mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                    	switch(anims.animation.getCurrentValue()) {
                    		case "1.7": {
                    		...
                    		case "Aladeen!!": {
                    			//this.transformFirstPersonItem(f, f1);
                    			GlStateManager.translate(0.56F, -0.6F, -0.571999997F);
                    	        GlStateManager.translate(-0.5F, -0.2 * -0.6F, 0.0F);
                    	        ...
                    	        GlStateManager.rotate(fa1 * 20.0F, 0.0F, 1.0F, 0.0F);
                    	        GlStateManager.rotate(fa1 * 50.0F, -1.0F, 0.0F, 0.0F);
                    	        GlStateManager.scale(0.3F, 0.3F, 0.3F);
		                        this.func_178103_d();
                    			break;
                    		}
                    		case "DEV": {
                                this.transformFirstPersonItem(f / 1.5F - .25F, 0.0F);
                                GlStateManager.scale(anims.itemScale.getValue(),anims.itemScale.getValue(),anims.itemScale.getValue());
                                this.func_178103_d();
                                GL11.glScaled(0.75,0.75,0.75);
                                GL11.glTranslated(0.0D, 0.0D, 0.0D);
                                float var8 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                GlStateManager.rotate(-var8 * 140.0F, 1.0F, 0.0F, 1.0F);
                                GlStateManager.rotate(var8 * 60.0F, 1.0F, 0.0F, 1.0F);
                                break;
                    		}
                            case "Exhibition": {
                                float var8 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                                ...
                                GlStateManager.translate(0.0,anims.extraY.getValue(),0.0);
                                this.func_178103_d();
                                break;
                            }
                            case "Dortware": {
